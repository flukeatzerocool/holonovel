...
31. Discovery quality — chunked reading, 7 extraction categories, cross-format consistency, reconciliation authority.
...
32. Convergence & quality enforcement — two-phase loop, no-delta detection, cross-model audit, adjusted thresholds.
