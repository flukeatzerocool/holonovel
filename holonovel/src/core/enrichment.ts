...
export const DEFAULT_ENRICHMENT: EnrichmentManifest = {
  ...
  voice_examples: [
    {
      ...
      source_url: "narrative_world_model/dmcp/README.md",
      confidence: "HIGH",
      tag: "vendor",
  ...
  lore_templates: [
    {
      ...
      source_url: "narrative_world_model/if-craft-corpus/README.md",
      confidence: "HIGH",
      tag: "vendor",
      hat_scope: "game_master",
  ...
  supplementary_guidance: [
    {
      ...
      source_url: "narrative_world_model/lonelog/lonelog.md",
      confidence: "HIGH",
      tag: "vendor",
      hat_scope: "game_master",
  ...
  narrative_voices: [
    ...
    },
    {
      ...
      source: "narrative_world_model/bitd/progress-clocks.md",
