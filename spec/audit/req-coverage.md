...
Bucket legend: A = certain gap (no source citation) · B = needs review (cited, no exercised test) · C = evidenced (cited + exercised) · D = spec-side (no `Check:` citation).
...
| REQ-010 | Traceability | 5.2 Extraction and Confidence | A | — | — |
| REQ-011 | Confidence (Part a) (3 sub-parts) | 5.2 Extraction and Confidence | A | — | — |
| REQ-012 | Graceful fallback | 5.2 Extraction and Confidence | A | — | — |
| REQ-013 | No assumed mechanics | 5.2 Extraction and Confidence | A | — | — |
| REQ-014 | Source immutability | 5.2 Extraction and Confidence | A | — | — |
| REQ-015 | Action classification | 5.2 Extraction and Confidence | A | — | — |
| REQ-016 | Guidance extraction | 5.2 Extraction and Confidence | A | — | — |
| REQ-017 | Badge stories | 5.2 Extraction and Confidence | A | — | — |
| REQ-018 | Extraction evidence | 5.2 Extraction and Confidence | A | — | — |
...
| REQ-067 | Help and tool discovery (Part a) (3 sub-parts) | 5.3 Tools, Resources, and Lookups | A | — | — |
...
| REQ-073 | Countdowns (Part c1) (5 sub-parts) | 5.6 State, Lifecycle, Entities, and Adventure Content | B | — | — |
| REQ-074 | Multi-entity support (Part a) (3 sub-parts) | 5.6 State, Lifecycle, Entities, and Adventure Content | B | — | — |
| REQ-075 | Named-NPC state (Part a) (5 sub-parts) | 5.6 State, Lifecycle, Entities, and Adventure Content | B | — | — |
| REQ-076 | Scene-state ledger (Part b1) (9 sub-parts) | 5.6 State, Lifecycle, Entities, and Adventure Content | B | — | — |
| REQ-077 | Entity personality fields (Part a) (6 sub-parts) | 5.6 State, Lifecycle, Entities, and Adventure Content | B | — | — |
...
| REQ-083 | Dynamic lore (Part a) (6 sub-parts) | 5.8 Synthesis, Lore, and Macros | B | — | — |
...
| REQ-099 | Confidence-floor acknowledgment | 5.2 Extraction and Confidence | A | — | — |
...
| REQ-102 | Source conversion contract (Part a) (3 sub-parts) | 5.2 Extraction and Confidence | A | — | — |
...
| REQ-107 | Version coordination (Part a) (2 sub-parts) | 5.3 Tools, Resources, and Lookups | A | — | — |
...
| REQ-111 | Search result quality (Part a) (2 sub-parts) | 5.2 Extraction and Confidence | A | — | — |
...
| REQ-125 | Scene transition hook (Part a) (2 sub-parts) | 5.8 Synthesis, Lore, and Macros | A | — | — |
...
| REQ-147 | Confidence aggregation (Part a) (2 sub-parts) | 5.2 Extraction and Confidence | A | — | — |
...
| REQ-153 | AGENTS.md troubleshooting | 5.2 Extraction and Confidence | A | — | — |
| REQ-154 | README.md handoff content (Part a) (2 sub-parts) | 5.2 Extraction and Confidence | A | — | — |
...
| REQ-161 | Intake workflow contract (Part a) (3 sub-parts) | 5.3 Tools, Resources, and Lookups | A | — | — |
| REQ-162 | Build-mode profiles (Part a) (3 sub-parts) | 5.3 Tools, Resources, and Lookups | A | — | — |
| REQ-163 | Client config verification (Part a) (2 sub-parts) | 5.3 Tools, Resources, and Lookups | A | — | — |
| REQ-164 | Viability pre-check (Part a) (2 sub-parts) | 5.3 Tools, Resources, and Lookups | A | — | — |
...
| REQ-187 | Spec content hash computation (Part a) (2 sub-parts) | 5.3 Tools, Resources, and Lookups | A | — | — |
...
| REQ-195 | World-model state tier (Part a) (2 sub-parts) | 5.10 World-Model Layer | C | I5, I10 | — |
...
| REQ-207 | Core-mechanic identification (Part a) (3 sub-parts) | 5.2 Extraction and Confidence | A | — | — |
| REQ-208 | Pattern Buffer convergence metric mapping (Part a) (2 sub-parts) | 5.20 Narrative Turn Conventions | A | — | — |
| REQ-209 | Cross-format consistency | 5.2 Extraction and Confidence | A | — | — |
| REQ-210 | Extraction categories (Part a) (2 sub-parts) | 5.2 Extraction and Confidence | A | — | — |
| REQ-211 | Evidence record field contract (Part a) (3 sub-parts) | 5.5 Badges and Access | A | — | — |
| REQ-212 | Generation table rolling (Part a) (2 sub-parts) | 5.2 Extraction and Confidence | A | — | — |
| REQ-213 | Weighted table result mapping (Part a) (3 sub-parts) | 5.7 Determinism, Safety, and Performance | B | — | — |
| REQ-214 | Table classification (Part a) (3 sub-parts) | 5.2 Extraction and Confidence | A | — | — |
| REQ-215 | Table content extraction (Part a) (3 sub-parts) | 5.2 Extraction and Confidence | A | — | — |
...
| REQ-225 | Ruleset Wisdom extraction (Part a) (2 sub-parts) | 5.2 Extraction and Confidence | B | — | — |
...
| REQ-233 | Factions (Part b1) (6 sub-parts) | 5.6 State, Lifecycle, Entities, and Adventure Content | B | — | — |
| REQ-234 | Secrets and knowledge (Part a) (4 sub-parts) | 5.8 Synthesis, Lore, and Macros | B | — | — |
| REQ-235 | Structured player choices (Part a) (3 sub-parts) | 5.4 Decision workflows | B | — | — |
| REQ-236 | Entity relationships (Part a) (3 sub-parts) | 5.6 State, Lifecycle, Entities, and Adventure Content | B | — | — |
...
| REQ-246 | Story journal (Part b1) (3 sub-parts) | 5.8 Synthesis, Lore, and Macros | B | — | — |
...
| REQ-272 | Stock elements catalog | 5.2 Extraction and Confidence | A | — | — |
...
| REQ-278 | Build-phase-map staleness detection | 5.3 Tools, Resources, and Lookups | A | — | — |
...
| REQ-285 | Server notes (Part a) (3 sub-parts) | 5.6 State, Lifecycle, Entities, and Adventure Content | B | — | — |
| REQ-286 | Knowledge-state section token (Part a) (3 sub-parts) | 5.5 Badges and Access | A | — | — |
| REQ-289 | Vow tracking (Part a) (5 sub-parts) | 5.6 State, Lifecycle, Entities, and Adventure Content | B | — | — |
...
| REQ-305 | Observer mode (Part a) (2 sub-parts) | 5.5 Badges and Access | A | — | — |
...
| REQ-315 | Full-text ruleset indexing (Part a) (2 sub-parts) | 5.2 Extraction and Confidence | A | — | — |
...
| REQ-321 | Codex (Part a) (16 sub-parts) | 5.6 State, Lifecycle, Entities, and Adventure Content | B | — | — |
...
| REQ-324 | Constraint override extraction | 5.2 Extraction and Confidence | A | — | — |
| REQ-325 | Constraint override catalog (Part a) (3 sub-parts) | 5.10 World-Model Layer | C | I3, I6 | — |
| REQ-326 | Scene-world coupling (Part a) (4 sub-parts) | 5.10 World-Model Layer | A | I10, I13 | — |
...
| REQ-335 | Scene beat taxonomy (Part a) (3 sub-parts) | 5.12 Narrative Architecture | A | — | gap |
| REQ-336 | Dramatic pacing signal (Part a) (2 sub-parts) | 5.12 Narrative Architecture | A | — | gap |
| REQ-337 | Narrative arc visibility (Part a) (2 sub-parts) | 5.12 Narrative Architecture | A | — | gap |
| REQ-338 | Faction autonomous advancement (Part a) (3 sub-parts) | 5.12 Narrative Architecture | A | — | gap |
| REQ-339 | NPC goal pursuit (Part a) (3 sub-parts) | 5.12 Narrative Architecture | A | — | gap |
| REQ-340 | Discovered consequences (Part a) (3 sub-parts) | 5.12 Narrative Architecture | A | — | gap |
| REQ-341 | Player-facing spatial surface (Part a) (3 sub-parts) | 5.12 Narrative Architecture | A | — | gap |
| REQ-342 | Scene description from world-model state (Part a) (2 sub-parts) | 5.12 Narrative Architecture | A | — | gap |
| REQ-343 | Unified intent resolution (Part a) (4 sub-parts) | 5.12 Narrative Architecture | A | — | gap |
| REQ-344 | Voice example feedback (Part a) (3 sub-parts) | 5.12 Narrative Architecture | A | — | gap |
| REQ-345 | Background-derived knowledge (Part a) (3 sub-parts) | 5.12 Narrative Architecture | A | — | gap |
| REQ-346 | Narrative coherence attestation (Part a1) (3 sub-parts) | 5.12 Narrative Architecture | A | — | gap |
| REQ-347 | Voice feedback codex capture (Part a) (3 sub-parts) | 5.12 Narrative Architecture | A | — | gap |
| REQ-348 | Faction-NPC goal coordination (Part a) (3 sub-parts) | 5.12 Narrative Architecture | A | — | gap |
| REQ-349 | Consequence-to-knowledge coupling (Part a) (3 sub-parts) | 5.12 Narrative Architecture | A | — | gap |
| REQ-350 | Background lore triggering (Part a) (3 sub-parts) | 5.12 Narrative Architecture | A | — | gap |
| REQ-351 | Pacing-triggered autonomy (Part a) (3 sub-parts) | 5.12 Narrative Architecture | A | — | gap |
| REQ-352 | Codex adventure beat sequences (Part a) (4 sub-parts) | 5.12 Narrative Architecture | A | — | gap |
| REQ-353 | Beat-accelerated countdown advancement | 5.12 Narrative Architecture | A | — | gap |
| REQ-354 | Extended narrative extraction | 5.2 Extraction and Confidence | A | — | gap |
| REQ-355 | Secret-countdown coupling (Part a) (2 sub-parts) | 5.12 Narrative Architecture | A | — | gap |
| REQ-356 | Vow-lore coupling (Part a) (2 sub-parts) | 5.12 Narrative Architecture | A | — | gap |
| REQ-357 | Story journal-faction coupling (Part a) (2 sub-parts) | 5.12 Narrative Architecture | A | — | gap |
| REQ-358 | Countdown-NPC disposition coupling (Part a) (2 sub-parts) | 5.12 Narrative Architecture | A | — | gap |
| REQ-359 | Relationship-countdown coupling (Part a) (2 sub-parts) | 5.12 Narrative Architecture | A | — | gap |
| REQ-360 | Lore-countdown coupling (Part a) (2 sub-parts) | 5.12 Narrative Architecture | A | — | gap |
| REQ-361 | NPC-vow coupling (Part a) (2 sub-parts) | 5.12 Narrative Architecture | A | — | gap |
| REQ-362 | Faction-vow coupling (Part a) (2 sub-parts) | 5.12 Narrative Architecture | A | — | gap |
| REQ-363 | Secret-world coupling (Part a) (2 sub-parts) | 5.12 Narrative Architecture | A | — | gap |
| REQ-364 | Faction-world coupling (Part a) (2 sub-parts) | 5.12 Narrative Architecture | A | — | gap |
| REQ-365 | Server notes narrative coupling (Part a) (3 sub-parts) | 5.12 Narrative Architecture | A | — | gap |
| REQ-366 | Observer narrative surface (Part a) (4 sub-parts) | 5.12 Narrative Architecture | A | — | gap |
...
| REQ-372 | Supplementary ruleset import (Part a) (5 sub-parts) | 5.14 Content Sources | A | — | — |
| REQ-373 | Dynamic tool registration (Part a1) (3 sub-parts) | 5.14 Content Sources | A | — | — |
...
| REQ-379 | Tool namespacing (Part a) (3 sub-parts) | 5.16 Multi-Ruleset Build | B | — | — |
| REQ-380 | Novel ruleset binding (Part a) (3 sub-parts) | 5.16 Multi-Ruleset Build | B | — | — |
| REQ-381 | Ruleset-scoped tool gating (Part a) (3 sub-parts) | 5.16 Multi-Ruleset Build | A | — | — |
| REQ-382 | Per-ruleset extraction isolation (Part a) (3 sub-parts) | 5.16 Multi-Ruleset Build | A | — | — |
| REQ-383 | Host ruleset health (Part a) (2 sub-parts) | 5.16 Multi-Ruleset Build | A | — | — |
| REQ-384 | Cross-ruleset Novel switching (Part a) (3 sub-parts) | 5.16 Multi-Ruleset Build | A | — | — |
| REQ-385 | suggest_actions cross-ruleset scoping (Part a) (2 sub-parts) | 5.16 Multi-Ruleset Build | A | — | — |
| REQ-386 | Cross-ruleset import rejection (Part a) (2 sub-parts) | 5.16 Multi-Ruleset Build | A | — | — |
| REQ-387 | Codex ruleset annotation (Part a) (2 sub-parts) | 5.16 Multi-Ruleset Build | A | — | — |
| REQ-388 | Holodeck config discovery (Part a) (4 sub-parts) | 5.3 Tools, Resources, and Lookups | A | — | — |
...
| REQ-395 | Ruleset-build entry point (Part a) (2 sub-parts) | 5.18 Workflow Entry Points | A | — | — |
| REQ-396 | Deploy preservation | 5.18 Workflow Entry Points | A | — | — |
| REQ-397 | Untracked state location | 5.18 Workflow Entry Points | A | — | — |
| REQ-398 | Deploy-model scope | 5.18 Workflow Entry Points | A | — | — |
...
| REQ-418 | Deployment verification | 5.18 Workflow Entry Points | A | — | — |
| REQ-419 | Editorial delta classification | 5.17 Ruleset Packages | A | — | — |
